...
CREATE TABLE customers (id VARCHAR(45) PRIMARY KEY NOT NULL, firstname TEXT, lastname TEXT, phone_number TEXT, street TEXT, city TEXT, state TEXT, zip TEXT);
CREATE TABLE order_details (order_number INT NOT NULL, batter_type TEXT, cake_type TEXT, quantity DOUBLE);
CREATE TABLE orders (order_number INT PRIMARY KEY NOT NULL AUTO_INCREMENT, customer_id VARCHAR(45), order_date DATE);
